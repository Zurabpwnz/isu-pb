<section class="requisition find-cost">
    ...
    <div class="requisition-text">
        <h3 class="requisition-text__title"><?php the_field( 'forma_-_uznat_stoimost_proekta_-_zagolovok', 'option' ); ?></h3>

        <p class="requisition-text__subtitle">
			<?php the_field( 'forma_-_uznat_stoimost_proekta_-_opisanie', 'option' ); ?></p>
    </div>
<div class="query-form">
	<?php echo do_shortcode( '[contact-form-7 id="731" title="Узнать стоимость проекта"]' ); ?>
</div>
</section> <!-- !requisition -->
